...
class SuiteNotifierActor extends TestKit(ActorSystem("NotifierActorTest")) with FunSpecLike
  ...
  before {
    ...
    var notifications = List(
      ...
      Notification("", "General", "Abuse scandal!!", "Cosby sexual assault", "error", "toast-top-right", "", 3000L),
      Notification("", "General", "Find news about the Iraq inquiry", "chilcot", "error", "toast-top-right", "", 1000L),
      Notification("", "General", "Mexico vs Donald trump", "mexico donald trump", "warning", "toast-top-right", "", 1000L),
     ...
     Notification("", "General", "Devastation in Orient", "china explosions tianjin", "info", "toast-top-right", "", 3000L),
      ...
      Notification("", "General", "Sexy, funny, accessible, enigmatic. Who was she?", "Marilyn Monroe", "warning", "toast-bottom-left", "", 2000L),
       Notification("", "General", "The only escape from the miseries of life are music and cats.", "cats kitten", "warning", "toast-bottom-left", "", 4000L),
      ...
      Notification("", "General", "Economic news", "debt revenue deficit tax income", "info", "toast-bottom-right", "", 1000L),
      ...
      Notification("", "General", "Travel & Holidays", "relax holiday dreaming", "info", "toast-bottom-right", "", 2000L),
